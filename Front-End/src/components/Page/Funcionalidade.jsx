  ...
  function handleSubmit(e) {
    ...
    axios
      ...
      .then((resp) => {
        ...
        if (mensagem == "") {
          setMensagem(
            "Dados enviado com sucesso. Obrigado por completar o cadastro!"
          );
          setType("success");
        }
    ...
    removeLoading ? (
      <section>
        ...
        <form className="user" onSubmit={handleSubmit}>
          ...
          <h5 className="novas">Novas opções de cadastro:</h5>
          <h6 className="textinho">Essas opções são opcionais</h6>
